					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tabela campeonado brasileiro",
									"targetURL": "#brasileirao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brasileirao-display": {
								"semanticObject": "brasileirao",
								"action": "display",
								"description": "Tabela campeonado brasileiro",
								"title": "Tabela campeonado brasileiro",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=brasileirao",
									"url": sap.ui.require.toUrl("brasileirao")
								}
							}
						}
					}
